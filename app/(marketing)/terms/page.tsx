        ...
        <div className="container mx-auto px-4 py-16 max-w-4xl">
          <div className="space-y-8">
            ...
            <div className="space-y-3">
              ...
              <Typography variant="p" className="text-muted-foreground mt-2 mb-2">
                You agree not to:
              </Typography>
              <ul className="space-y-2 ml-6 list-disc text-muted-foreground">
            ...
            <div className="space-y-3">
              ...
              <Typography variant="p" className="text-muted-foreground">
                Ottie processes your data in accordance with our Privacy Policy (available at <Link href="https://www.ottie.com" className="text-primary underline">www.ottie.com</Link>). By using the Service, you consent to our data processing practices.
              </Typography>
            ...
            <div className="space-y-3">
              ...
              <Typography variant="p" className="text-muted-foreground">
                Before initiating arbitration or litigation, you agree to attempt to resolve any dispute through informal negotiation. You must provide Ottie with written notice (email to <Link href="mailto:legal@ottie.com" className="text-primary underline">legal@ottie.com</Link>) describing the dispute, and we will attempt to resolve it within 30 days.
              </Typography>
            </div>
            ...
            <div className="space-y-3">
              ...
              <Typography variant="p" className="text-muted-foreground">
                You may terminate your account and these Terms at any time by logging into your account and selecting "Delete Account" or by emailing <Link href="mailto:support@ottie.com" className="text-primary underline">support@ottie.com</Link>.
              </Typography>
            ...
            <div className="space-y-3">
              ...
              <div className="ml-4 space-y-2 text-muted-foreground">
                <Typography variant="p">
                  ...
                  Email: <Link href="mailto:legal@ottie.com" className="text-primary underline">legal@ottie.com</Link><br />
                  Website: <Link href="https://www.ottie.com" className="text-primary underline">www.ottie.com</Link>
                </Typography>
                <Typography variant="p" className="mt-4">
                  <strong>For GDPR-related inquiries:</strong><br />
                  Data Protection Officer: <Link href="mailto:dpo@ottie.com" className="text-primary underline">dpo@ottie.com</Link>
                </Typography>
              </div>
            </div>
