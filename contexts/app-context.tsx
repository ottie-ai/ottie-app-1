...
interface AppContextType {
  ...
  hasPlanFeature: (planName: string | null | undefined, feature: keyof Pick<Plan, 'feature_lead_generation' | 'feature_custom_domain' | 'feature_analytics' | 'feature_api_access' | 'feature_priority_support' | 'feature_3d_tours' | 'feature_pdf_flyers' | 'feature_crm_sync' | 'feature_password_protection'>) => boolean
}
...
export function AppProvider({ 
  ...
  const hasPlanFeature = (
    ...
    feature: keyof Pick<Plan, 'feature_lead_generation' | 'feature_custom_domain' | 'feature_analytics' | 'feature_api_access' | 'feature_priority_support' | 'feature_3d_tours' | 'feature_pdf_flyers' | 'feature_crm_sync' | 'feature_password_protection'>
