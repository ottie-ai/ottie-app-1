...
const socialLinks = [
  { icon: Linkedin, href: 'https://linkedin.com/company/ottie', label: 'LinkedIn' },
  { icon: Twitter, href: 'https://twitter.com/ottieapp', label: 'Twitter' },
]
...
const organizationSchema = {
  ...
  name: 'Ottie',
  url: 'https://ottie.com',
  logo: 'https://ottie.com/logo.png',
  description: 'Property websites in 60 seconds. Free for realtors.',
  sameAs: socialLinks.map((s) => s.href),
}

const FooterComponent = () => {
  return (
    <footer className="relative bg-[var(--dark-bg)] border-t border-white/10">
      {/* Organization Schema */}
      <script
      ...
      <div className="w-full max-w-5xl mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-white/50 text-sm max-w-xs mb-6">
              Property websites in 60 seconds. Free for realtors.
            </p>
            {/* Social Links */}
            <div className="flex items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="flex items-center justify-center w-9 h-9 rounded-lg bg-white/5 border border-white/10 text-white/60 hover:text-white hover:bg-white/10 transition-colors"
        ...
        <div className="pt-8 border-t border-white/10">
          <p className="text-white/30 text-xs text-center">
            © {new Date().getFullYear()} Ottie. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
