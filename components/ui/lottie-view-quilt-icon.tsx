...
import viewQuiltAnimation from '@/lib/lottie/system-regular-173-view-quilt-hover-quilt.json'

interface LottieViewQuiltIconProps {
  className?: string
  size?: number
  invertTheme?: boolean
...
export function LottieViewQuiltIcon({ className = '', size = 18, invertTheme, autoLoop = false }: LottieViewQuiltIconProps) {
  ...
  if (autoLoop) {
    return (
      ...
      >
        <LottieIcon
          animationData={viewQuiltAnimation}
          size={size}
