...
const typographyVariants = cva("", {
  variants: {
    variant: {
      h1: "scroll-m-20 text-5xl leading-[60px] font-bold tracking-normal",
      h2: "scroll-m-20 text-4xl leading-[50px] font-semibold tracking-normal",
      h3: "scroll-m-20 text-3xl leading-[44px] font-semibold tracking-normal",
      h4: "scroll-m-20 text-2xl leading-10 font-semibold tracking-normal",
