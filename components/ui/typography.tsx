...
const typographyVariants = cva("", {
  variants: {
    variant: {
      ...
      "heading-xl": "scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl",
      "heading-lg": "scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight first:mt-0",
      "heading-md": "scroll-m-20 text-2xl font-semibold tracking-tight",
      "heading-sm": "scroll-m-20 text-xl font-semibold tracking-tight",
