...
-- This column stores the vision analysis results from Llama 3.2 90B Vision
...
COMMENT ON COLUMN temp_previews.image_analysis IS 'Vision analysis results from Llama 3.2 90B Vision. Contains best_hero_index, reasoning, and per-image scores for composition, lighting, wow_factor, and quality.';
